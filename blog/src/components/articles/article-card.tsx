...
export function ArticleCard({ article }: ArticleCardProps) {
  const articleUrl = `${PUBLIC_ROUTES.ARTICLE_DETAIL}/${article.articleId}`;
  const imageUrl = article.imageUrl ?? "/placeholder.png";

  return (
    <Link href={articleUrl} className="group block first:pt-0 last:pb-0">
